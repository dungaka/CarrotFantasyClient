...
namespace ETTools
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            ProcessHelper.Run(protoc, "--csharp_out=\"../CarrotFantasy/Assets/ET.Core/Module/Message/\" --proto_path=\"./\" OuterMessage.proto", waitExit: true);
            ProcessHelper.Run(protoc, "--csharp_out=\"../CarrotFantasy/Assets/ET.Core/Module/Message/\" --proto_path=\"./\" HotfixMessage.proto", waitExit: true);
        ...
        private const string clientMessagePath = "../CarrotFantasy/Assets/ET.Core/Module/Message/";
        private const string hotfixMessagePath = "../CarrotFantasy/Assets/Model/Module/Message/";
    ...
    {
        private const string protoPath = ".";
        private const string serverMessagePath = "../CarrotFantasy/Assets/ET.Core/Module/Message/";
        private static readonly char[] splitChars = { ' ', '\t' };
        private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();
